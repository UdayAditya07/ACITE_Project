...
background_image_url = "https://www.xavor.com/wp-content/uploads/2023/03/AI-is-Revolutionizing-Disease-Diagnosis-and-Treatment-min.webp"  # Replace with your image URL
...
models = {
    'diabetes': pickle.load(open('Diabete_model.pkl', 'rb')),
    'heart_disease': pickle.load(open('heart_model.pkl', 'rb')),
    'parkinsons': pickle.load(open('Parkinsons.pkl', 'rb')),
    'lung_cancer': pickle.load(open('lung_cancer.pkl', 'rb')),
